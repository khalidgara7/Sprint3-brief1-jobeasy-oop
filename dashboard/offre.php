                ...
                <table class="agent table align-middle bg-white" style="min-width: 700px;">
                    ...
                    ?>
                        <tr class="freelancer">
                            <td>
                                <div class="ms-3">
                                    <p class="fw-bold mb-1 f_name"> <?=$offer['OffreID']?> </p>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="ms-3">
                                        <p class="fw-bold mb-1 f_name"> <?=$offer['TitreOffre']?> </p>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <p class="fw-normal mb-1 f_title"><?=$offer['DescriptionOffre']?></p>

                            </td>
                            <td>
                                <a href="#" class="f_status"><?=$offer['Localisation']?></a>
                            </td>
                            <td>
                                <p class="fw-normal mb-1 f_title"><?=$offer['Statut']?></p>
                                <!--<a href="#" class="f_status"><?php /*=$offer['Statut']*/?></a>-->
                            </td>
